...
logger = logging.getLogger("pybammsolvers.solvers.idaklu_jax")

idaklu_spec = importlib.util.find_spec("pybammsolvers.solvers.idaklu")
...
class IDAKLUJax:
    ...
    def __init__(
        ...
        if not pybammsolvers.has_idaklu():
            raise ModuleNotFoundError(
